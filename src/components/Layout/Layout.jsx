            ...
            <div style={{display: 'flex', alignItems: 'center', gap: '12px', flexShrink: 0}}>
              ...
              >
                <div style={{position: 'relative', width: '28px', height: '28px'}}>
                  ...
                  {unreadAnnouncementCount > 0 && (
                    <span style={{position: 'absolute', top: '-6px', right: '-6px', background: '#ef4444', color: '#ffffff', borderRadius: '50%', width: '18px', height: '18px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.65rem', fontWeight: 900, lineHeight: 1}}>
              ...
              {isAdmin && (
                <button
                  ...
                  style={{color: '#fbbf24', background: 'none', border: 'none', cursor: 'pointer', padding: '4px', display: 'flex', alignItems: 'center'}}
