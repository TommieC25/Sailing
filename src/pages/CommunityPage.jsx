...
const styles = {
  ...
  searchInput: { flex: 1, minWidth: '200px', padding: '12px', fontSize: '1rem', border: '2px solid #ddd', borderRadius: '8px', fontFamily: 'inherit' },
  selectInput: { padding: '12px', fontSize: '1rem', border: '2px solid #ddd', borderRadius: '8px', fontFamily: 'inherit', minWidth: '150px' },
  ...
  photo: { width: '80px', height: '80px', borderRadius: '50%', objectFit: 'cover', flexShrink: 0, border: '2px solid #ddd' },
  photoPlaceholder: { width: '80px', height: '80px', borderRadius: '50%', background: '#e2e8f0', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '2rem', flexShrink: 0, border: '2px solid #ddd' },
